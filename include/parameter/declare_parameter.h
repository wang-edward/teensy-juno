...
void declare_parameters() {
    ...
    lpf_envelope_level.declare(88, 0 , 9, scale_lpf_envelope_level, update_lpf_mod);
    lpf_lfo_level.declare(89, 0, 10, scale_lpf_lfo_level, update_lpf_mod);
    lpf_keyboard_level.declare(90, 0, 11, scale_lpf_keyboard_level, update_lpf_mod);
    ...
    flanger_frequency.declare(28, 0, 15, scale_flanger_frequency, update_flanger);
    flanger_frequency_fine.declare(29, 1, 0, scale_flanger_frequency_fine, update_flanger);
